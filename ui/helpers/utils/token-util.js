 ...
 * in the ERC721 and ERC1155 ABIs from metamask-eth-abis (https://github.com/AcriaWallet/metamask-eth-abis/tree/main/src/abis)
 *
 * @param {object} tokenData - ethers Interface token data.
 * @returns {string | undefined} A decimal string value.
 */
...
export async function getAssetDetails(
  ...
  // not sure why since it doesn't match the ERC721 ABI spec we use to parse these transactions - https://github.com/AcriaWallet/metamask-eth-abis/blob/d0474308a288f9252597b7c93a3a8deaad19e1b2/src/abis/abiERC721.ts#L62.
  let tokenId =
